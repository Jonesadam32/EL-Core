 ...
 *
 * Manual invoice entry and list view.
 * Voice-friendly form design for Wispr dictation.
 *
...
<div class="el-bk-tab-header">
    <div class="el-bk-tab-header-left">
        ...
        <p class="description" style="margin:4px 0 0;">
            <?php esc_html_e( 'Track invoices sent to clients. Match invoices to deposits in Phase A.9.', 'el-core' ); ?>
        </p>
    </div>
    <div class="el-bk-tab-header-right">
        <button class="el-btn el-btn-primary" id="el-bk-add-invoice-btn">
            <?php esc_html_e( '+ Add Invoice', 'el-core' ); ?>
        </button>
    </div>
</div>
...
<!-- Invoice Entry Form (hidden by default) -->
<div id="el-bk-invoice-form" class="el-bk-card el-bk-invoice-form-card" style="display:none;">
    ...
    <div class="el-bk-invoice-form-grid">
        ...
        <!-- Row 3: Withholding (conditional - show amount field when type selected) -->
...
<?php if ( empty( $invoices ) ) : ?>
    <?php echo EL_Admin_UI::notice( [ // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        'message' => __( 'No invoices yet. Click "+ Add Invoice" to create your first invoice record.', 'el-core' ),
        'type'    => 'info',
    ] ); ?>
<?php else : ?>
